...
extern bool enable_benchmarking;
extern int smooth_prefetch_target;
extern bool start_smooth;
extern bool start_prefetch;
...
/* renata */
extern void cost_smooth_heap_scan(Path *path, PlannerInfo *root, RelOptInfo *baserel,
					  ParamPathInfo *param_info,
					  Path *bitmapqual, double loop_count);
