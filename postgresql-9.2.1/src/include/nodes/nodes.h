...
typedef enum NodeTag
{
	...
	T_EState,
	T_TupleTableSlot,
	T_SmoothScanInfo,      /* renata: this could be used in the future for bookeeping information */
	...
	T_IndexSmoothScan,	/* this one is similar to index scan*/
	T_SmoothHeapScan,	/* this one is similar to bitmap heap scan*/
	T_SmoothIndexScan,	/* this one is similar to bitmap index scan*/
