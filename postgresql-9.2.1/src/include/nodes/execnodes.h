...
/* renata todo: change this*/
typedef struct IndexSmoothScanState
{
	ScanState	ss;				/* its first field is NodeTag */
	List	   *indexqualorig;
	ScanKey		iss_ScanKeys;
	int			iss_NumScanKeys;
	/* for Smooth Scan keys the order corresponds to actual order - from indexqualorig (and not indexquals)*/
	ScanKey		iss_SmoothScanKeys;
	int			iss_NumSmoothScanKeys;
	IndexRuntimeKeyInfo *iss_RuntimeSmoothKeys;
	int			iss_NumRuntimeSmoothKeys;
	bool		iss_RuntimeSmoothKeysReady;
	ScanKey		iss_OrderBySmoothKeys;
	int			iss_NumOrderBySmoothKeys;
	ExprContext *iss_RuntimeSmoothContext;
/***********************************************/
	ScanKey		iss_OrderByKeys;
	int			iss_NumOrderByKeys;
	IndexRuntimeKeyInfo *iss_RuntimeKeys;
 ...
 * 		Smooth index scan is in charge of accessing the index and obtaining TIDs
 * 		Smooth heap scan is in charge of fetching the tuples based on TIDs from the index
 *
...
typedef struct SmoothHeapScanState
{
	ScanState	ss;				/* its first field is NodeTag */
	List	   *shs_bitmapqualorig;
	TIDBitmap  *shs_tbm;
	TBMIterator *shs_tbmiterator;
	TBMIterateResult *shs_tbmres;
	TBMIterator *shs_prefetch_iterator;
	int			shs_prefetch_pages;
	int			shs_prefetch_target;

} SmoothHeapScanState;

/* ----------------
 *	 SmoothIndexScanState information  - for accessing the index
 *
 ...
 * ----------------
 */
typedef struct SmoothIndexScanState
{
	ScanState	ss;				/* its first field is NodeTag */
	TIDBitmap  *sis_result;
	ScanKey		sis_ScanKeys;
	int			sis_NumScanKeys;
	IndexRuntimeKeyInfo *sis_RuntimeKeys;
	int			sis_NumRuntimeKeys;
	IndexArrayKeyInfo *sis_ArrayKeys;
	int			sis_NumArrayKeys;
	bool		sis_RuntimeKeysReady;
	ExprContext *sis_RuntimeContext;
	Relation	sis_RelationDesc;
	IndexScanDesc sis_ScanDesc;
