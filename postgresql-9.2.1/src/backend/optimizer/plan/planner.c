...
/* renata: remove this once you are done with debugging*/
...
/* renata : here I can save the value of tuple_fraction and compare it with actual -
 * once they are different I call again subquery_planner - with updated tuple_fraction*/
Plan *
				 ...
				 PlannerInfo **subroot)
{
	...
	/* renata: print chosen plan for a subquery: subquery_planner */
	//elog_node_display(INFO, "Chosen plan for subquery", plan,
	//							  true);
...
grouping_planner(PlannerInfo *root, double tuple_fraction)
{
	...
	else
	{
		...
		/* renata : after query planner in grouping_planner cheapest path is: */
		...
		else
		{
			 ...
			 *
			 * */
			//elog_node_display(INFO, "Result plan", result_plan,
			//							  true);
