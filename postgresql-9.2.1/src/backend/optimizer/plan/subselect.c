			  ...
			  Bitmapset *scan_params)
{
	...
	switch (nodeTag(plan))
	{
		...
		case T_IndexSmoothScan:
			finalize_primnode((Node *) ((IndexSmoothScan *) plan)->indexqual,
							  &context);
			finalize_primnode((Node *) ((IndexSmoothScan *) plan)->indexorderby,
							  &context);
		...
		case T_SmoothIndexScan:
			finalize_primnode((Node *) ((SmoothIndexScan *) plan)->sis_indexqual,
							  &context);
		...
		case T_SmoothHeapScan:
			finalize_primnode((Node *) ((SmoothHeapScan *) plan)->shs_bitmapqualorig,
							  &context);
			context.paramids = bms_add_members(context.paramids, scan_params);
			break;
