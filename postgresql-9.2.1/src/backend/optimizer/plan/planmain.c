			  ...
			  double *num_groups)
{
	...
	*sorted_path = sortedpath;
	...
	/* renata print cheapest path and sorted path per subquery - grouping_planner will choose the best one */
	/* print also tuple_fraction!!! this is expected cardinality */
	//elog_node_display(INFO, "Cheapest path", cheapestpath,
	//						  true);
	//elog_node_display(INFO, "Sorted path", sortedpath,
	//							  true);
