...
//
//	/* renata
//	 * Consider index smooth scans */
//	if(enable_indexsmoothscan){
//		printf("index smooth scan is enabled. calling create_indexsmooth_paths\n");
//		create_indexsmooth_paths(root, rel);
//	}
//
//
//	/* renata
//	 * Add smooth scan path */
//	if(enable_smoothscan){
//		create_smooth_scan_paths(root, rel);
//	}
//
//	/* Consider TID scans */
