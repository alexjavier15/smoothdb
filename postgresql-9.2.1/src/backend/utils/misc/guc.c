...
static const struct config_enum_entry client_message_level_options[] = {
	...
	{"debug1", DEBUG1, false},
	{"log", LOG, false},
	{"info_mjoin2", INFO_MJOIN2, false},
	{"info_mjoin1", INFO_MJOIN1, false},
	{"info", INFO, true},
	{"notice", NOTICE, false},
...
static struct config_bool ConfigureNamesBool[] =
{
	...
	/* renata: reoptimize flag*/
	{
			{"reoptimize", PGC_USERSET, QUERY_TUNING_METHOD,
				gettext_noop("Enables reoptimization procedure (SmoothDB)."),
				NULL
			},
			&reoptimize,
			true,
	...
	/* renata: materialize flag*/
	{
			{"materialize", PGC_USERSET, QUERY_TUNING_METHOD,
				gettext_noop("Enables materialization of intermediates (SmoothDB)."),
				NULL
			},
			&materialize,
			true,
	...
	/* renata: enable_indexsmoothscan flag*/
	{
			{"enable_indexsmoothscan", PGC_USERSET, QUERY_TUNING_METHOD,
				gettext_noop("Enables index smooth scan (started from an index scan) (SmoothDB)."),
				NULL
			},
			&enable_indexsmoothscan,
			true,
			NULL, NULL, NULL
	},
	{
...

	{
				...
				&enable_smoothnestedloop,
				true,
				NULL, NULL, NULL
		},
	{
				{"enable_skewcheck", PGC_USERSET, QUERY_TUNING_METHOD,
					gettext_noop("Enables check whether we have skew. Go both ways. (SmoothDB)."),
					NULL
				},
				&enable_skewcheck,
				true,
	...
	{
				{"enable_benchmarking", PGC_USERSET, QUERY_TUNING_METHOD,
					gettext_noop("Enables printing number of tuples fetched for skew check. (SmoothDB)."),
					NULL
				},
				&enable_benchmarking,
				true,
	...
	/* renata: collect statistics flag*/
	{
			{"collect_statistics", PGC_USERSET, QUERY_TUNING_METHOD,
				gettext_noop("Enables statistics collection over the source table (SmoothDB)."),
				NULL
			},
			&collect_statistics,
			true,
	...
	{
			{"enable_smoothsorting", PGC_USERSET, QUERY_TUNING_METHOD,
				gettext_noop("Enables sorting of page IDs before fetching actual pages (SmoothDB)."),
				NULL
			},
			&enable_smoothsorting,
			true,
			NULL, NULL, NULL
	},
	{
			{"enable_smoothscan", PGC_USERSET, QUERY_TUNING_METHOD,
				gettext_noop("Enables the planner's use of Smooth Index Scan operator (SmoothDB)."),
				NULL
			},
			&enable_smoothscan,
			true,
	...
	{
		{"enable_mhashjoin", PGC_USERSET, QUERY_TUNING_METHOD,
...
static struct config_int ConfigureNamesInt[] =
{
	...
	{ /*renata: number of tuples after which to perform the switch*/
			{"num_tuples_switch", PGC_SIGHUP, WAL_ARCHIVING,
				gettext_noop("Forces a switch after 'num_tuples_switch. (SmoothDB)"),
				NULL
			},
			&num_tuples_switch,
			-1, -1, INT_MAX,
	...
	{ /*renata: number of tuples after which to start prefetcher*/
				{"num_tuples_prefetch", PGC_SIGHUP, WAL_ARCHIVING,
					gettext_noop("Starts prefetcher after 'num_tuples_prefetch. (SmoothDB)"),
					NULL
				},
				&num_tuples_prefetch,
				-1, -1, INT_MAX,
	...
	{ /*renata: maximum number of pages for smooth prefetcher */
			{"smooth_prefetch_target", PGC_SIGHUP, WAL_ARCHIVING,
				gettext_noop("What is the maximum number of pages to prefetch with Smooth Operators (SmoothDB)"),
				NULL
			},
