...
/* renata
 * changes for Index Smooth Scan
 * prefetch a chunk of blocks
 *	smgrprefetch() -- Initiate asynchronous read of the specified block of a relation.
 */
void
smgrprefetch_smooth(SMgrRelation reln, ForkNumber forknum, BlockNumber blocknum, int num_blocks)
{
	mdprefetch_smooth(reln, forknum, blocknum, num_blocks);
}
