...
btgettuple(PG_FUNCTION_ARGS)
{
	 ...
	 */
	//renata: smooth scan info will also adjust keys
...
btgetbitmap(PG_FUNCTION_ARGS)
{
	...
	do
	{
		...
		if (_bt_first(scan, ForwardScanDirection))
		{
			...
			/* renata: here hash table is create Every page is key, value is pageEntry - and there we have a bitmap of tuples that qualify */
...
//		}
//		ss->markItemIndex = -1;
//		/* renata: create workspace for smooth scan */
