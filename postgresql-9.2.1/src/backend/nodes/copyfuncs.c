...
/*
 * _copyIndexSmoothScan
 */
static IndexSmoothScan *
_copyIndexSmoothScan(const IndexSmoothScan *from)
{
	IndexSmoothScan  *newnode = makeNode(IndexSmoothScan);
	...
	COPY_NODE_FIELD(indexorderbyorig);
	COPY_SCALAR_FIELD(indexorderdir);
	COPY_NODE_FIELD(allqual);
	return newnode;
}


/*
 * _copySmoothIndexScan
 */
static SmoothIndexScan *
_copySmoothIndexScan(const SmoothIndexScan *from)
{
	SmoothIndexScan *newnode = makeNode(SmoothIndexScan);
	 ...
	 * copy remainder of node
	 */
	COPY_SCALAR_FIELD(sis_indexid);
	COPY_NODE_FIELD(sis_indexqual);
	COPY_NODE_FIELD(sis_indexqualorig);
...
_copySmoothHeapScan(const SmoothHeapScan *from)
{
	SmoothHeapScan *newnode = makeNode(SmoothHeapScan);
	 ...
	 * copy remainder of node
	 */
	COPY_NODE_FIELD(shs_bitmapqualorig);
...
copyObject(const void *from)
{
	...
	switch (nodeTag(from))
	{
		...
		case T_IndexSmoothScan:
			retval = _copyIndexSmoothScan(from);
			break;
		case T_SmoothIndexScan:
			retval = _copySmoothIndexScan(from);
			break;
		case T_SmoothHeapScan:
			retval = _copySmoothHeapScan(from);
			break;
