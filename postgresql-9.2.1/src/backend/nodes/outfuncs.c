...
static void
_outIndexSmoothScan(StringInfo str, const IndexSmoothScan *node)
{
	WRITE_NODE_TYPE("INDEXSMOOTHSCAN");
	...
	WRITE_NODE_FIELD(indexorderby);
	WRITE_NODE_FIELD(indexorderbyorig);
	WRITE_NODE_FIELD(allqual);
	WRITE_ENUM_FIELD(indexorderdir, ScanDirection);
}

static void
_outSmoothIndexScan(StringInfo str, const SmoothIndexScan *node)
{
	WRITE_NODE_TYPE("SMOOTHINDEXSCAN");

	_outScanInfo(str, (const Scan *) node);

	WRITE_OID_FIELD(sis_indexid);
	WRITE_NODE_FIELD(sis_indexqual);
	WRITE_NODE_FIELD(sis_indexqualorig);
}

static void
_outSmoothHeapScan(StringInfo str, const SmoothHeapScan *node)
{
	WRITE_NODE_TYPE("SMOOTHHEAPSCAN");

	_outScanInfo(str, (const Scan *) node);

	WRITE_NODE_FIELD(shs_bitmapqualorig);
}
...
static void
_outSmoothHeapPath(StringInfo str, const SmoothHeapPath *node)
{
	WRITE_NODE_TYPE("SMOOTHHEAPPATH");

	_outPathInfo(str, (const Path *) node);

	WRITE_NODE_FIELD(shp_bitmapqual);
}
	...
	else
	{
		...
		switch (nodeTag(obj))
		{
			...
			case T_IndexSmoothScan:
				_outIndexSmoothScan(str, obj);
				break;
			case T_SmoothIndexScan:
				_outSmoothIndexScan(str, obj);
				break;
			case T_SmoothHeapScan:
				_outSmoothHeapScan(str, obj);
				break;
			...
			case T_IndexPath:
				...
				break;
			case T_SmoothHeapPath:
				_outSmoothHeapPath(str, obj);
				break;
