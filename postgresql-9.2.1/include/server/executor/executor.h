...
/*renata: this value denotes whether reoptimization should be done or not */
extern bool reoptimize;
/*renata: this value denotes whether we should materialize intermediates */
extern bool materialize;
/* renata:  should we collect statistics on actual table */
...
/* just for measuring time in the executor */
extern int SDBTimevalSubtract(struct timeval *result, struct timeval *t2, struct timeval *t1);
